...
export const INITIAL_HEROES: Hero[] = [
    {
        id: 'h1', name: 'Guerreiro', type: 'hero', class: 'Warrior', emoji: '🛡️', unlocked: true, isDead: false, element: 'nature', assignment: 'combat', insanity: 0, level: 1, xp: 0, maxXp: 100, fatigue: 0, maxFatigue: 100, statPoints: 0, skills: [
    ...
    {
        id: 'h2', name: 'Mago', type: 'hero', class: 'Mage', emoji: '🔮', unlocked: false, isDead: false, element: 'fire', assignment: 'combat', insanity: 0, level: 1, xp: 0, maxXp: 100, fatigue: 0, maxFatigue: 100, statPoints: 0, skills: [
    ...
    {
        id: 'h3', name: 'Curandeiro', type: 'hero', class: 'Healer', emoji: '💚', unlocked: false, isDead: false, element: 'water', assignment: 'combat', insanity: 0, level: 1, xp: 0, maxXp: 100, fatigue: 0, maxFatigue: 100, statPoints: 0, skills: [
    ...
    { id: 'h4', name: 'Ladino', type: 'hero', class: 'Rogue', unlocked: false, emoji: '🗡️', isDead: false, element: 'nature', assignment: 'combat', insanity: 0, level: 1, xp: 0, maxXp: 100, fatigue: 0, maxFatigue: 100, statPoints: 0, skills: [], stats: { hp: 85, maxHp: 85, mp: 50, maxMp: 50, attack: 25, magic: 5, defense: 5, speed: 15 } },
    { id: 'h5', name: 'Paladino', type: 'hero', class: 'Paladin', unlocked: false, emoji: '✝️', isDead: false, element: 'fire', assignment: 'combat', insanity: 0, level: 1, xp: 0, maxXp: 100, fatigue: 0, maxFatigue: 100, statPoints: 0, skills: [], stats: { hp: 150, maxHp: 150, mp: 40, maxMp: 40, attack: 10, magic: 15, defense: 15, speed: 8 } },
    { id: 'h6', name: 'Bruxo', type: 'hero', class: 'Warlock', unlocked: false, emoji: '☠️', isDead: false, element: 'water', assignment: 'combat', insanity: 0, level: 1, xp: 0, maxXp: 100, fatigue: 0, maxFatigue: 100, statPoints: 0, skills: [], stats: { hp: 60, maxHp: 60, mp: 120, maxMp: 120, attack: 5, magic: 35, defense: 2, speed: 9 } },
    { id: 'h7', name: 'Dragoon', type: 'hero', class: 'Dragoon', unlocked: false, emoji: '🐉', isDead: false, element: 'fire', assignment: 'combat', insanity: 0, level: 1, xp: 0, maxXp: 100, fatigue: 0, maxFatigue: 100, statPoints: 0, skills: [], stats: { hp: 130, maxHp: 130, mp: 50, maxMp: 50, attack: 35, magic: 10, defense: 8, speed: 14 } },
    { id: 'h8', name: 'Sábio', type: 'hero', class: 'Sage', unlocked: false, emoji: '📜', isDead: false, element: 'light', assignment: 'combat', insanity: 0, level: 1, xp: 0, maxXp: 100, fatigue: 0, maxFatigue: 100, statPoints: 0, skills: [], stats: { hp: 75, maxHp: 75, mp: 150, maxMp: 150, attack: 5, magic: 40, defense: 4, speed: 10 } },
    { id: 'h9', name: 'Necromante', type: 'hero', class: 'Necromancer', unlocked: false, emoji: '🦴', isDead: false, element: 'dark', assignment: 'combat', insanity: 0, level: 1, xp: 0, maxXp: 100, fatigue: 0, maxFatigue: 100, statPoints: 0, skills: [], stats: { hp: 90, maxHp: 90, mp: 100, maxMp: 100, attack: 10, magic: 30, defense: 6, speed: 8 } },
    { id: 'h10', name: 'Bardo', type: 'hero', class: 'Bard', unlocked: false, emoji: '🎻', isDead: false, element: 'neutral', assignment: 'combat', insanity: 0, level: 1, xp: 0, maxXp: 100, fatigue: 0, maxFatigue: 100, statPoints: 0, skills: [], stats: { hp: 80, maxHp: 80, mp: 100, maxMp: 100, attack: 10, magic: 20, defense: 5, speed: 12 } },
    { id: 'h11', name: 'Monge', type: 'hero', class: 'Monk', unlocked: false, emoji: '🧘', isDead: false, element: 'neutral', assignment: 'combat', insanity: 0, level: 1, xp: 0, maxXp: 100, fatigue: 0, maxFatigue: 100, statPoints: 0, skills: [], stats: { hp: 110, maxHp: 110, mp: 30, maxMp: 30, attack: 18, magic: 5, defense: 10, speed: 14 } },
    { id: 'h12', name: 'Patrulheiro', type: 'hero', class: 'Ranger', unlocked: false, emoji: '🏹', isDead: false, element: 'nature', assignment: 'combat', insanity: 0, level: 1, xp: 0, maxXp: 100, fatigue: 0, maxFatigue: 100, statPoints: 0, skills: [], stats: { hp: 90, maxHp: 90, mp: 40, maxMp: 40, attack: 22, magic: 5, defense: 5, speed: 15 } },
    { id: 'h13', name: 'Druida', type: 'hero', class: 'Druid', unlocked: false, emoji: '🌿', isDead: false, element: 'nature', assignment: 'combat', insanity: 0, level: 1, xp: 0, maxXp: 100, fatigue: 0, maxFatigue: 100, statPoints: 0, skills: [], stats: { hp: 100, maxHp: 100, mp: 80, maxMp: 80, attack: 10, magic: 15, defense: 8, speed: 10 } },
    { id: 'h14', name: 'Berserker', type: 'hero', class: 'Berserker', unlocked: false, emoji: '🪓', isDead: false, element: 'fire', assignment: 'combat', insanity: 0, level: 1, xp: 0, maxXp: 100, fatigue: 0, maxFatigue: 100, statPoints: 0, skills: [], stats: { hp: 140, maxHp: 140, mp: 20, maxMp: 20, attack: 30, magic: 0, defense: 0, speed: 12 } },
    { id: 'h15', name: 'Feiticeiro', type: 'hero', class: 'Sorcerer', unlocked: false, emoji: '⚡', isDead: false, element: 'fire', assignment: 'combat', insanity: 0, level: 1, xp: 0, maxXp: 100, fatigue: 0, maxFatigue: 100, statPoints: 0, skills: [], stats: { hp: 60, maxHp: 60, mp: 150, maxMp: 150, attack: 5, magic: 35, defense: 2, speed: 10 } },
    { id: 'h16', name: 'Templário', type: 'hero', class: 'Templar', unlocked: false, emoji: '🛡️✨', isDead: false, element: 'light', assignment: 'combat', insanity: 0, level: 1, xp: 0, maxXp: 100, fatigue: 0, maxFatigue: 100, statPoints: 0, skills: [], stats: { hp: 160, maxHp: 160, mp: 50, maxMp: 50, attack: 15, magic: 10, defense: 25, speed: 8 } },
    { id: 'h17', name: 'Assassino', type: 'hero', class: 'Assassin', unlocked: false, emoji: '🗡️🌑', isDead: false, element: 'dark', assignment: 'combat', insanity: 0, level: 1, xp: 0, maxXp: 100, fatigue: 0, maxFatigue: 100, statPoints: 0, skills: [], stats: { hp: 80, maxHp: 80, mp: 40, maxMp: 40, attack: 35, magic: 5, defense: 3, speed: 18 } },
    { id: 'h18', name: 'Engenheiro', type: 'hero', class: 'Engineer', unlocked: false, emoji: '🔧', isDead: false, element: 'fire', assignment: 'combat', insanity: 0, level: 1, xp: 0, maxXp: 100, fatigue: 0, maxFatigue: 100, statPoints: 0, skills: [], stats: { hp: 100, maxHp: 100, mp: 60, maxMp: 60, attack: 15, magic: 15, defense: 12, speed: 10 } },
    { id: 'h19', name: 'Alquimista', type: 'hero', class: 'Alchemist', unlocked: false, emoji: '⚗️', isDead: false, element: 'nature', assignment: 'combat', insanity: 0, level: 1, xp: 0, maxXp: 100, fatigue: 0, maxFatigue: 100, statPoints: 0, skills: [], stats: { hp: 90, maxHp: 90, mp: 80, maxMp: 80, attack: 10, magic: 25, defense: 5, speed: 11 } },
    { id: 'h20', name: 'Ilusionista', type: 'hero', class: 'Illusionist', unlocked: false, emoji: '🎭', isDead: false, element: 'dark', assignment: 'combat', insanity: 0, level: 1, xp: 0, maxXp: 100, fatigue: 0, maxFatigue: 100, statPoints: 0, skills: [], stats: { hp: 70, maxHp: 70, mp: 120, maxMp: 120, attack: 5, magic: 30, defense: 5, speed: 15 } },
    { id: 'h21', name: 'Samurai', type: 'hero', class: 'Samurai', unlocked: false, emoji: '🏯', isDead: false, element: 'fire', assignment: 'combat', insanity: 0, level: 1, xp: 0, maxXp: 100, fatigue: 0, maxFatigue: 100, statPoints: 0, skills: [], stats: { hp: 100, maxHp: 100, mp: 40, maxMp: 40, attack: 28, magic: 5, defense: 8, speed: 14 } },
    { id: 'h22', name: 'Viking', type: 'hero', class: 'Viking', unlocked: false, emoji: '🛶', isDead: false, element: 'water', assignment: 'combat', insanity: 0, level: 1, xp: 0, maxXp: 100, fatigue: 0, maxFatigue: 100, statPoints: 0, skills: [], stats: { hp: 150, maxHp: 150, mp: 20, maxMp: 20, attack: 25, magic: 0, defense: 10, speed: 9 } },
    { id: 'h23', name: 'Ninja', type: 'hero', class: 'Ninja', unlocked: false, emoji: '🥷', isDead: false, element: 'dark', assignment: 'combat', insanity: 0, level: 1, xp: 0, maxXp: 100, fatigue: 0, maxFatigue: 100, statPoints: 0, skills: [], stats: { hp: 80, maxHp: 80, mp: 50, maxMp: 50, attack: 20, magic: 10, defense: 5, speed: 20 } },
    { id: 'h24', name: 'Pirata', type: 'hero', class: 'Pirate', unlocked: false, emoji: '🏴‍☠️', isDead: false, element: 'water', assignment: 'combat', insanity: 0, level: 1, xp: 0, maxXp: 100, fatigue: 0, maxFatigue: 100, statPoints: 0, skills: [], stats: { hp: 110, maxHp: 110, mp: 30, maxMp: 30, attack: 22, magic: 5, defense: 8, speed: 12 } },
    { id: 'h25', name: 'Pescador', type: 'hero', class: 'Fisherman', unlocked: false, emoji: '🎣', isDead: false, element: 'water', assignment: 'combat', insanity: 0, level: 1, xp: 0, maxXp: 100, fatigue: 0, maxFatigue: 100, statPoints: 0, skills: [], stats: { hp: 95, maxHp: 95, mp: 40, maxMp: 40, attack: 12, magic: 10, defense: 10, speed: 10 } },
    { id: 'h26', name: 'Ferreiro', type: 'hero', class: 'Blacksmith', unlocked: false, emoji: '⚒️', isDead: false, element: 'fire', assignment: 'combat', insanity: 0, level: 1, xp: 0, maxXp: 100, fatigue: 0, maxFatigue: 100, statPoints: 0, skills: [], stats: { hp: 120, maxHp: 120, mp: 30, maxMp: 30, attack: 20, magic: 5, defense: 15, speed: 9 } },
    { id: 'h27', name: 'Minerador', type: 'hero', class: 'Miner', unlocked: false, emoji: '⛏️', isDead: false, element: 'nature', assignment: 'combat', insanity: 0, level: 1, xp: 0, maxXp: 100, fatigue: 0, maxFatigue: 100, statPoints: 0, skills: [], stats: { hp: 110, maxHp: 110, mp: 20, maxMp: 20, attack: 15, magic: 5, defense: 12, speed: 8 } },
];
...
export const ANCIENT_RELICS: AncientRelic[] = [
    ...
    { id: 'relic_banner', name: 'Estandarte Destruído', description: '+5% Defesa de GvG por unidade', bonusType: 'gvg_defense', bonusValue: 0.05, count: 0, emoji: '🚩' },
    { id: 'relic_gear', name: 'Engrenagem de Cerco', description: '-10% Custo de Mitra/Ferro na Indústria por unidade', bonusType: 'industry_cost', bonusValue: -0.10, count: 0, emoji: '⚙️' }
];