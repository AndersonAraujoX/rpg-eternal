    ...
    return (
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center p-4 z-50">
            <div className="bg-gray-900 p-6 rounded-lg max-w-lg w-full border border-amber-600 relative flex flex-col gap-4 shadow-xl">
                ...
                <h2 className="text-2xl font-bold text-amber-500 mb-2 flex items-center gap-2"><Coins /> A Taverna</h2>
                ...
                <div className="flex flex-col gap-6">
                    ...
                    <div className="bg-gray-800 p-4 rounded border border-gray-700">
                        ...
                        <div className="flex gap-2">
                            ...
                            >
                                Convocar 10 ({cost10}o)
                            </button>
                        </div>
                        <div className="text-xs text-gray-400 mt-2 flex items-center gap-1">
                            <Info size={12} /> Equipe Atual: {heroes.length} Heróis
                        </div>
                    </div>
