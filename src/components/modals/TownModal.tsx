                            ...
                            {visibleBuildings.filter(b => b.id !== 'town_hall').map(building => {
                                ...
                                return (
                                    <div
                                        ...
                                        ${isSpecial && building.level === 0 ? 'border-amber-500/50 bg-amber-950/20 shadow-[0_0_20px_rgba(245,158,11,0.15)]' : 'border-stone-800 hover:border-amber-600/50 shadow-xl'}`}
                                    >
                                        {/* Building Header */}
                ...
                {viewMode === 'pantheon' && (
                    <div className="flex-1 flex flex-col overflow-hidden relative">
                        ...
                        <div className="bg-stone-950/80 border border-amber-900/30 rounded-xl p-4 mb-6 flex justify-around items-center gap-4 text-center">
                            <div>
                                <span className="block text-[10px] text-stone-550 uppercase tracking-widest font-bold">Ataque Global</span>
                                <span className="font-mono text-lg font-bold text-red-400">+{activeBonuses.attack}%</span>
                            </div>
                            <div className="h-8 w-px bg-stone-800/30" />
                            <div>
                                <span className="block text-[10px] text-stone-550 uppercase tracking-widest font-bold">Defesa Global</span>
                                <span className="font-mono text-lg font-bold text-yellow-400">+{activeBonuses.defense}%</span>
                            </div>
                            <div className="h-8 w-px bg-stone-800/30" />
                            <div>
                                <span className="block text-[10px] text-stone-550 uppercase tracking-widest font-bold">Velocidade Global</span>
                                <span className="font-mono text-lg font-bold text-cyan-400">+{activeBonuses.speed}%</span>
                            </div>
                            <div className="h-8 w-px bg-stone-800/30" />
                            <div>
                                <span className="block text-[10px] text-stone-550 uppercase tracking-widest font-bold">Vampirismo Global</span>
                                <span className="font-mono text-lg font-bold text-purple-400">+{activeBonuses.lifesteal}%</span>
                            </div>
                            <div className="h-8 w-px bg-stone-800/30" />
                            <div>
                                <span className="block text-[10px] text-stone-550 uppercase tracking-widest font-bold">HP Máximo Global</span>
                                <span className="font-mono text-lg font-bold text-green-400">+{activeBonuses.maxHp}%</span>
                            </div>
                            <div className="h-8 w-px bg-stone-800/30" />
                            <div>
                                <span className="block text-[10px] text-stone-550 uppercase tracking-widest font-bold">Ouro Ganho</span>
                                ...
                                <div className="flex-1 overflow-y-auto pr-2 custom-scrollbar">
                                    {(() => {
                                        ...
                                        if (availableHeroes.length === 0) {
                                            return (
                                                <div className="h-full flex flex-col items-center justify-center text-center p-8 border-2 border-dashed border-stone-900 rounded-xl bg-stone-950/50">
                                                        ...
                                                        >
                                                            ...
                                                            <div className="flex items-center gap-4">
                                                                <div className="text-right">
                                                                    <span className="text-[10px] text-stone-555 block uppercase tracking-wider font-semibold">Bônus</span>
                        ...
                        {!patronDeity ? (
                            <div className="flex-1 flex flex-col justify-center overflow-y-auto max-h-[60vh] pr-2 custom-scrollbar">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto w-full">
                                    {/* Aurelius */}
                                    <div className="bg-gradient-to-b from-amber-955/40 via-stone-900 to-black border-2 border-amber-600/30 rounded-2xl p-6 flex flex-col justify-between hover:border-amber-500 hover:shadow-[0_0_20px_rgba(245,158,11,0.2)] transition-all duration-300 group">
                                        <div>
                                    ...
                                    {/* Tenebris */}
                                    <div className="bg-gradient-to-b from-purple-955/40 via-stone-900 to-black border-2 border-purple-900/30 rounded-2xl p-6 flex flex-col justify-between hover:border-purple-500 hover:shadow-[0_0_20px_rgba(168,85,247,0.2)] transition-all duration-300 group">
                                        <div>
                                    ...
                                    {/* Gaya */}
                                    <div className="bg-gradient-to-b from-green-955/40 via-stone-900 to-black border-2 border-green-900/30 rounded-2xl p-6 flex flex-col justify-between hover:border-green-500 hover:shadow-[0_0_20px_rgba(34,197,94,0.2)] transition-all duration-300 group">
                                        <div>
                                            <div className="text-5xl text-center mb-4 group-hover:scale-110 transition-transform duration-300">🌿</div>
                                ...
                                <div className="flex-1 bg-stone-900/60 border border-stone-850 p-6 rounded-2xl flex flex-col justify-between">
                                    <div>
                                        <div className="flex items-center gap-4 mb-6">
                                            <div className="text-6xl p-3 bg-stone-955 rounded-2xl border border-stone-800">
                                        ...
                                        <div className="mb-6">
                                            ...
                                            <div className="w-full bg-stone-955 h-3 rounded-full border border-stone-850 overflow-hidden p-0.5">
                                                <div
                                            ...
                                            <p className="text-[10px] text-stone-550 mt-1 italic text-left">Ofereça almas ou divindade para aumentar seu favor e elevar o nível do deus.</p>
                                        </div>
