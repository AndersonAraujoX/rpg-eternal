...
const baseProps = {
    ...
    buildings: [
        ...
        mockBuilding('pantheon', 'Panteão', 1),
...
describe('TownModal', () => {
    ...
    it('navigates to construction mode and renders buildings', () => {
        render(<TownModal {...baseProps} />);
        const gerenciarBtn = screen.getByText('Gerenciar Cidade');
    ...
    it('navigates to deities view and renders deity selection', () => {
        render(<TownModal {...baseProps} />);
        // Go to construction first
        fireEvent.click(screen.getByText('Gerenciar Cidade'));
        // Click the Altar dos Deuses button
        const altarBtn = screen.getByText('ACESSAR ALTAR DOS DEUSES');
    ...
    it('renders deity detail view when a patron is set', () => {
        ...
        // Navigate to deities view
        fireEvent.click(screen.getByText('Gerenciar Cidade'));
        fireEvent.click(screen.getByText('ACESSAR ALTAR DOS DEUSES'));
