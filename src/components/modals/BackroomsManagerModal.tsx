    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/95 p-2 md:p-4 overflow-auto">
            ...
            <div className="bg-black border-4 border-amber-600 rounded-lg w-full max-w-4xl shadow-[0_0_30px_rgba(217,119,6,0.3)] relative text-amber-500 flex flex-col font-mono overflow-hidden">
                    ...
                    <button
                        ...
                        className={`px-3 py-1.5 border transition-all ${
                            activeTab === 'exploradores'
                                ? 'bg-amber-600 text-black border-amber-400 font-black'
                                : 'bg-transparent text-amber-600 border-amber-950 hover:border-amber-800'
                        }`}
                    >
                        [01] MONITOR DE EXPLORAÇÃO
                    </button>
                    <button
                ...
                {/* Body Content */}
                {activeTab === 'exploradores' ? (
                    <div className="p-4 flex flex-col md:flex-row gap-4 overflow-y-auto max-h-[80vh] z-10 bg-black animate-fade-in">
                    ...
                    /* Tech Tree Tab */
                    <div className="p-4 flex flex-col gap-4 overflow-y-auto max-h-[80vh] z-10 bg-black animate-fade-in">
                        <div className="border border-amber-700 bg-amber-950/10 p-3 rounded text-[11px] text-amber-600 mb-2">
                                            ...
                                            {isUnlocked ? (
                                                ...
                                                <button
                                                    ...
                                                    className={`px-3 py-1.5 rounded text-xs font-bold border transition-all ${
                                                        canAfford
                                                        ? 'bg-amber-600 border-amber-400 text-black hover:bg-amber-500'
                                                        : 'bg-black text-amber-900 border-amber-955 cursor-not-allowed'
                                                    }`}
                                                >
                                                    Iniciar Pesquisa
                                                </button>
