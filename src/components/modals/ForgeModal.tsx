    ...
    return (
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center p-4 z-50">
            <div className="bg-gray-900 p-6 rounded-lg max-w-2xl w-full border border-orange-700 relative flex flex-col gap-4 shadow-xl">
                ...
                <h2 className="text-2xl font-bold text-orange-500 flex items-center gap-2"><Hammer /> A Forja</h2>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {/* Seção de Melhorias */}
                    <div className="flex flex-col gap-3">
                        <h3 className="font-bold text-gray-300 border-b border-gray-700 pb-1">Melhorias de Equipamento</h3>

                        <div className="flex justify-between items-center bg-gray-800 p-3 rounded border border-gray-700">
                            <span className="text-orange-300 text-sm">Conjunto de Cobre (+10 Stats)</span>
                        ...
                        <div className="flex justify-between items-center bg-gray-800 p-3 rounded border border-gray-700">
                            <span className="text-slate-300 text-sm">Conjunto de Ferro (+25 Stats)</span>
                        ...
                        <div className="flex justify-between items-center bg-gray-800 p-3 rounded border border-gray-700">
                            <span className="text-cyan-300 text-sm">Conjunto de Mithril (+50 Stats)</span>
