...
const TECH_META: Record<string, { icon: string; category: 'Economia' | 'Combate' | 'Exploração' | 'Cósmico'; targetModule: 'industry' | 'galaxy' | 'combat' | 'economy' | 'cosmic' }> = {
    alchemical_distill: { icon: '🧴', category: 'Exploração', targetModule: 'economy' },
    cult_rotation: { icon: '🌱', category: 'Economia', targetModule: 'economy' },
    iron_metallurgy: { icon: '⛏️', category: 'Economia', targetModule: 'economy' },
    windmills: { icon: '💨', category: 'Economia', targetModule: 'economy' },
    steam_engine: { icon: '🚂', category: 'Economia', targetModule: 'economy' },
    superconductors_liminal: { icon: '⚡', category: 'Economia', targetModule: 'industry' },
    large_mining: { icon: '🌋', category: 'Economia', targetModule: 'economy' },
    liminal_beacons: { icon: '📡', category: 'Economia', targetModule: 'industry' },
    fission_nuclear: { icon: '☢️', category: 'Combate', targetModule: 'combat' },
    quantum_automation: { icon: '🤖', category: 'Economia', targetModule: 'industry' },
    silicon_network: { icon: '💻', category: 'Combate', targetModule: 'combat' },
    dimensional_science_pack: { icon: '🧪', category: 'Economia', targetModule: 'industry' },
    cosmic_radar: { icon: '🛰️', category: 'Exploração', targetModule: 'galaxy' },
    clean_fusion: { icon: '⚡', category: 'Economia', targetModule: 'economy' },
    quantum_computing: { icon: '🔮', category: 'Combate', targetModule: 'combat' },
    antimatter_reactor: { icon: '⚛️', category: 'Economia', targetModule: 'industry' },
    hyperdense_alloy_hull: { icon: '🛸', category: 'Cósmico', targetModule: 'galaxy' },
    antimatter_prop: { icon: '✨', category: 'Cósmico', targetModule: 'galaxy' },
    asteroid_mining: { icon: '☄️', category: 'Cósmico', targetModule: 'galaxy' },
...
const TECH_FLOW: { from: string; to: string }[] = [
    ...
    { from: 'steam_engine', to: 'superconductors_liminal' },
    { from: 'superconductors_liminal', to: 'large_mining' },
    { from: 'large_mining', to: 'liminal_beacons' },
    { from: 'liminal_beacons', to: 'fission_nuclear' },
    { from: 'fission_nuclear', to: 'quantum_automation' },
    { from: 'quantum_automation', to: 'silicon_network' },
    { from: 'silicon_network', to: 'dimensional_science_pack' },
    { from: 'dimensional_science_pack', to: 'cosmic_radar' },
    { from: 'cosmic_radar', to: 'clean_fusion' },
    { from: 'clean_fusion', to: 'quantum_computing' },
    { from: 'quantum_computing', to: 'antimatter_reactor' },
    { from: 'antimatter_reactor', to: 'hyperdense_alloy_hull' },
    { from: 'hyperdense_alloy_hull', to: 'antimatter_prop' },
    { from: 'antimatter_prop', to: 'asteroid_mining' },
